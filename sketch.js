var p1,p2,UFO1,UFO2,UFO3,bomb;
var blast,blastImage,space,spaceImage;
var spaceShip,spaceShipImage, laserImage,BombImg;
var shoot = 0;
var score = 0;
var laser,ufoGroup,laserGroup,bombGroup;
var explosionSound,laserSound,explasionImage,blastSound;
var instruction = 0;
var play = 1;
var end = 2;
...
function preload() {
  ...
  spaceShipImage = loadAnimation("Images/Rocket_1.png","Images/Rocket_2.png","Images/Rocket_3.png");
  laserImage = loadAnimation("Images/Laser_1.png","Images/Laser_2.png","Images/Laser_3.png","Images/Laser_4.png","Images/Laser_5.png","Images/Laser_6.png","Images/Laser_7.png","Images/Laser_8.png");
...
function draw() {
  ...
  if(gameState === play) {
    ...
    if(spaceShip.isTouching(bombGroup)||laserGroup.isTouching(bombGroup)){
      gameState = end;
      explosionSound.play();
    }
  ...
  if(gameState === instruction) {
    ...
    stroke("tan");
    strokeWeight(2);
    text(" #The spaceship or the lasers should not touch the bombs",canvas.width/2-350,canvas.height/2-50);
...
function createBomb(){
   if(frameCount % 500 === 0){
     bomb=createSprite(Math.round(random(50,950)),-20,10,10);
